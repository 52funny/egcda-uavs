...
impl codec::Encoder<GsRequest> for GsRegisterCodec {
    type Error = std::io::Error;
    fn encode(&mut self, item: GsRequest, dst: &mut bytes::BytesMut) -> Result<(), Self::Error> {
...
impl codec::Decoder for GsRegisterCodec {
    ...
    fn decode(&mut self, src: &mut bytes::BytesMut) -> Result<Option<Self::Item>, Self::Error> {
        ...
        let item = GsResponse::decode(&data[4..])?;
        Ok(Some(item))
    }
}
